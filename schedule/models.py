...
class Schedule(models.Model):
    ...
    schedule_title = models.CharField('Titulo', max_length=30, blank=False, null=False)
    ...
    schedule_name_collaborator = models.CharField('Nome do colaborador', max_length=100, blank=False, null=False)
    schedule_meet_link = models.URLField('Link de reunião', max_length=150, blank=True, null=True)
    schedule_meet_location = models.CharField('Local da Reunião', max_length=50, blank=True, null=True)
...
class DelSchedule(models.Model):
    ...
    delschedule_title = models.CharField('Titulo', max_length=30, blank=False, null=False)
    ...
    delschedule_name_collaborator = models.CharField('Nome do colaborador', max_length=100, blank=False, null=False)
    delschedule_meet_link = models.URLField('Link de reunião', max_length=150, blank=True, null=True)
    delschedule_meet_location = models.CharField('Local da Reunião', max_length=50, blank=True, null=True)
