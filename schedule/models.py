...
class Schedule(models.Model):
    ...
    schedule_topic = models.CharField('Tópico', max_length=45, blank=False,null=False)
    schedule_date_hour = models.DateTimeField('Data Hora inicial', blank=False, null=False)
    schedule_name_creator = models.CharField('Nome do criador', max_length=45, blank=False, null=False)
    schedule_name_receiver = models.CharField('Nome do recebidor', max_length=45, blank=False, null=False)
    schedule_meet_link = models.URLField('Link de reunião',max_length=150 ,blank=False, null=False)
    schedule_meet_location = models.CharField('Local da Reunião',max_length=45 ,blank=False, null=False)
...
class DelSchedule(models.Model):
    ...
    delschedule_name_creator = models.CharField('Nome do criador', max_length=45, blank=False, null=False)
    delschedule_name_receiver = models.CharField('Nome do recebidor', max_length=45, blank=False, null=False)
    delschedule_meet_link = models.URLField('Link de reunião',max_length=150 ,blank=False, null=False)
    delschedule_meet_location = models.CharField('Local da Reunião',max_length=45 ,blank=False, null=False)
